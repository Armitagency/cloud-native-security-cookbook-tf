...
resource "azurerm_network_security_rule" "private_default_ingress" {
...
resource "azurerm_network_security_rule" "private_default_egress" {
  name                        = "private_default_egress"
  priority                    = 4096
  direction                   = "Outbound"
  access                      = "Deny"
  protocol                    = "*"
